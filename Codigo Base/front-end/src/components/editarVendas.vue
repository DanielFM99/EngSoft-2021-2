      ...
      <b-form @submit.prevent="handleSubmit">
        <b-row>
          <b-col>
            ...
            <b-form-input type="text" v-model="dados.valor"> </b-form-input>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            ...
            <b-form-input type="text" v-model="dados.produtos"></b-form-input>
          </b-col>
        </b-row>
...
export default {
  ...
  methods: {
    ...
    editar() {
      editarVenda(
        {
          nomeCliente: this.dados.nomeCliente,
